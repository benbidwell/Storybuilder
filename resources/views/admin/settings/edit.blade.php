...
<section class="wrapper">
    ...
    <div class="form-body">
        <div class="form-group">
            <label class="control-label">Google Analytics Code ID</label>
            <div class="input-icon right">
             
                <input type="text" name="google_analytics_code" value="{{$adminsetting[0]->google_analytics_code}}" class="form-control"> 
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-icon right">
                <textarea class="form-control input-block-level" id="summernote_1" name="pundit_title_text" rows="18">{{$adminsetting[0]->pundit_title_text}}</textarea>
